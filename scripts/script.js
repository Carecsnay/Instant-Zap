...
function sendToWhatsapp(message) {
    ...
    //CHECAR SE O USUÁRIO ESTÁ MEXENDO DO CELULAR OU DO COMPUTADOR
    ...
    //SE ELE ESTIVER ACESSANDO DO CELULAR, SERÁ UTILIZADO O SEGUNDO LINK E VICE-VERSA
    let urlApi = "https://web.whatsapp.com/send?phone=55";
    if (mobileCheck()) {
...
//MANEIRA ANTIGA DE SE FAZER MANDAR MSG PARA O WHATSAPP (PRECISA DO WHATSAPP INSTALADO/SERVE PARA MOBILE TBM)
